...
public class GasthausMain {
        ...
        try {
            ...
            while (true) {
                ...
                case 10:
                    ...
                    break;
                case 11:
                    GasthausAufbau.rechnungErstellen();
                    break;
                case 12:
                    GasthausAufbau.rechnungenAnsehen();
                    break;
                case 13:
                	GasthausAufbau.leaderboardAnsehen();
                	break;
                case 14:
                	Beispieldaten.beispieldatenEinfuegen();
                	break;
                case 0:
    ...
    private static void showMenu() {
        ...
        System.out.println("5) Mitarbeiter hinzufügen");
        ...
        System.out.println("12) Rechnungen ansehen");
        System.out.println("13) Leaderboard ansehen");
        System.out.println("14) Beispieldaten einfügen");
        System.out.println("0) Beenden");
    }

    public static String readString(String prompt, String standardWert) {
    ...
    public static int readInt(String prompt, int standardWert) {
        while (true) {
            System.out.print(prompt);
            String input = sc.nextLine();
